<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('img_preview_main_slider')); ?>:</b>
	<?php echo CHtml::encode($data->img_preview_main_slider); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('img_preview_coming_soon')); ?>:</b>
	<?php echo CHtml::encode($data->img_preview_coming_soon); ?>
	<br />
