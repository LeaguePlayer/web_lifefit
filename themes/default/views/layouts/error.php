...
<!--[if gt IE 8]><!--> <html class="no-js bg_404"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
		...
		В честь этого мы дарим Вам один бесплатный гостевой визит.</p>
				...
				<div class="info-right">
					...
					<ul>
						...
						<li>
							<a href="/page/tanceval-nye-napravleniya">Танцевальные направления</a>
						</li>
						<li>
			...
			<div class="bot">
				<ul>
					...
					<li class="logo-amobile">
						<a class="fitnes" href="amobile-studio.ru">
							сайт делали в <span class="logo-amobile"></span><br>
							<span class="justify">только лучшие идеи</span>
						</a>
					</li>
				</ul>
			</div>
