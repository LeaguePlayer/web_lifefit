<?php
/**
 * Миграция m140429_063642_partners
 *
 * @property string $prefix
 */
 
class m140429_063642_partners extends CDbMigration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{partners}}', array(
			...
			'img_preview' => "string COMMENT 'Логотип партнера'",
			'link' => "string COMMENT 'Ссылка на сайт партнера'",
