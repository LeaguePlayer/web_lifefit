...
<?php echo $form->dropDownListControlGroup($model,'map', array(0=>'Нет', 1=>'Да'),array('class'=>'span8')); ?> 
...
<div class='control-group'>
	...
	<?php echo $form->textAreaControlGroup($model,'wswg_body',array('rows'=>6, 'cols'=>50, 'class'=>'span12')); ?>
